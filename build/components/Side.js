   ...
   {/* <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="https://res.cloudinary.com/dnu3bviq2/image/upload/f_auto,q_auto/pgbtf7dxkbebtxcbbicu" class="d-block w-100" alt="..."></img>
      </div>
      <div class="carousel-item">
        <img src="https://res.cloudinary.com/dnu3bviq2/image/upload/f_auto,q_auto/zdyfz1ikmrbxshj9dfrv" class="d-block w-100" alt="..."></img>
      </div>
      <div class="carousel-item">
        <img src="https://res.cloudinary.com/dnu3bviq2/image/upload/f_auto,q_auto/qcjyskyzznp4mvh0e7x2" class="d-block w-100" alt="..."></img>
      </div>
      <div class="carousel-item">
        <img src="https://res.cloudinary.com/dnu3bviq2/image/upload/f_auto,q_auto/gsj38s1pfrgkrcmlumw9" class="d-block w-100" alt="..."></img>
      </div>
      <div class="carousel-item">
        <img src="https://res.cloudinary.com/dnu3bviq2/image/upload/f_auto,q_auto/wvolm2eznc7mkd38xje6" class="d-block w-100" alt="..."></img>
      </div>
      </div>
    </div>
...
Request to Shareholders for Updation of their Email Address , etc.
State wise GST Number of IRCTC
SConcierge (Cab/Coach) & Porter Service at Major Railway Stations(24-10-2018)
Public Notice-Recruitment Fraud.
Request to Shareholders for Updation of their Email Address , etc.
State wise GST Number of IRCTC
SConcierge (Cab/Coach) & Porter Service at Major Railway Stations(24-10-2018) */}
<br></br>
<div class="overscroll-none ...">   1. Public Notice-Recruitment Fraud.
...
5.Public Notice-Recruitment Fraud.
6.Request to Shareholders for Updation of their Email Address , etc.
7.State wise GST Number of IRCTC
8.SConcierge (Cab/Coach) & Porter Service at Major Railway Stations(24-10-2018)</div>
{/* <div>
      <button onClick={() => goUp(okay)}></button>
      <br />
      <textarea id="text" placeholder="YOUR NOTES" />
      <br />
      <button onClick={() => goDown(okay)}></button>
    </div> */}
    </Typography>
    <div class="space-y-4">
    <Typography variant="h5" color="blue-gray" className="mb-2">
...
<div class="grid grid-cols-4 gap-4">
    <div>
    <img
      src="https://res.cloudinary.com/dbmixotrs/image/upload/f_auto,q_auto/j61ojip8jkwvomtq7ki7"
      alt="image 1"
      className="h-20 w-25"
     />
    </div>
    <div>
    <img
      src="https://res.cloudinary.com/dbmixotrs/image/upload/f_auto,q_auto/ncbp26pnjty1dr4j8hoy"
      alt="image 1"
      className="h-20 w-25"
     />
    </div>
    <div>
    <img
      src="https://res.cloudinary.com/dbmixotrs/image/upload/f_auto,q_auto/xafa1n14uj08crcvskot"
      alt="image 1"
      className="h-20 w-25"
     />
    </div>
    <div>
    <img
      src="https://res.cloudinary.com/dbmixotrs/image/upload/f_auto,q_auto/pbsxquk1nzcuvbylmftq"
      alt="image 1"
      className="h-20 w-25"
     />
    </div>
  ...
  <footer className="relative w-full">
      <div className="mx-auto w-full max-w-7xl px-8">
        ...
        <div className="flex w-full flex-col items-center justify-center border-t border-blue-gray-50 py-4 md:flex-row md:justify-between">
          ...
          >
            &copy; {currentYear} <a href="https://material-tailwind.com/">IRCTC</a>. All
            Rights Reserved.
          </Typography>
